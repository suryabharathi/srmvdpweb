		...
		stickyMenu: function( headerOffset ){
			...
			if ($window.scrollTop() > 39) {
				if( $body.hasClass('device-lg') || $body.hasClass('device-md') ) {
					...
					if( !$headerWrap.hasClass('force-not-dark') ) { $headerWrap.addClass('not-dark'); }
...
$(document).ready(function() {
        $('#page-menu #page-menu-wrap > div').removeClass('container');
        $('#page-menu #page-menu-wrap > div').addClass('container-fluid');
	});
	$(".applylnk").click(function(){
		var link=$(this).attr("data-link");
		var ac=$(this).attr("data-href");
		
		
		$.get( '//services.lpu.in/api/programsearch/InsertApplyNow?link='+link, function( data ) {
			window.location = ac;
			//setTimeout(() => window.open(ac), 1500);
